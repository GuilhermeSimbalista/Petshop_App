...
if (isset($_GET['id'])) {
  ...
  if (isset($_POST) & !empty($_POST)) {
    $servico['nome'] = $database->sanitize($_POST['nome']);
    $servico['descricao'] = $database->sanitize($_POST['descricao']);
    $servico['valor'] = $database->sanitize($_POST['valor']);
    $res = $database->update('tb_servicos', 'id', $id, $servico);
    if ($res) {
...
<body>
  ...
  <div class="container">
    ...
    <main class="container text-center">
      ...
      <form action="update_servico.php?id=<?php echo $servico['id']; ?>" id="formAlterarServico" method="post" class="needs-validation" novalidate>
        <div class="container">
          <div class="col-md-12">
            <div class="form-row justify-content-center align-items-center">
              <div class="form-group col-md-4">
                <label for="inputNome">Nome</label>
                <input type="text" class="form-control" id="inputNome" name="nome" value="<?php echo $servico['nome']; ?>" required>
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" class="form-control" id="inputValor" name="valor" value="<?php echo $servico['valor']; ?>">
              </div>
            </div>
          </div>
          <div class="col-md-12">
            <div class="form-row justify-content-center align-items-center">
              <div class="form-group col-md-6">
                ...
                <textarea class="form-control" id="inputDescricao" name="descricao" required rows="6"><?php echo $servico['descricao']; ?></textarea>
                <div class="valid-tooltip">
                  Looks good!
                </div>
              </div>

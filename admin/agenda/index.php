        ...
        <table class="table">
          ...
          <tbody>
            ...
            ?>
              <tr>
                <td><?php echo $r['id'] ?></td>
                <td><?php echo $r['id_servico'] ?></td>
                <td><?php echo $r['data'] ?></td>
                <td><?php echo $r['hora'] ?></td>
                <td><?php echo $r['cliente'] ?></td>
                <td><?php echo $r['nome_animal'] ?></td>
                <td><?php echo $r['tipo_animal'] ?></td>
                <td><a href="update_agenda.php?id=<?php echo $r['id']; ?>">Editar</a> <a href="delete_agenda.php?id=<?php echo $r['id']; ?>">Excluir</a></td>
              </tr>
            <?php
            }
            ?>
